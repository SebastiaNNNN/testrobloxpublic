...
from api._common import as_users_map, firebase_get, houses_list, read_json, send_json, validate_admin
...
class handler(BaseHTTPRequestHandler):
    ...
    def do_POST(self):
        ...
        houses = houses_list(users, query, limit)

        send_json(self, 200, {"ok": True, "count": len(houses), "houses": houses})
